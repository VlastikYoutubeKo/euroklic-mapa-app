...
names, monochrome variant included for Android 13+ themed icons), plus legacy square+round PNG
fallbacks in `mipmap-{m,h,x,xx,xxx}hdpi/` (48/72/96/144/192px, generated by the backend session
via ImageMagick, replacing the old placeholder `.webp` files) for pre-API26 devices. Verified
