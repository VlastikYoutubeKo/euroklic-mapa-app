...
**Zbylá otevřená otázka — `photo_url`:** appka se ptá, jestli je
plnění fotek plánované a odkud by se brala. To je produktová otázka,
ne něco, co jde ověřit proti kódu — nemám na ni odpověď z repa.
